 ...
 * Handles login form functionality, OTP verification, and form validation
 */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Display admin credentials in console for testing
    ...
    if (verifyOtpBtn) {
        verifyOtpBtn.addEventListener('click', (e) => {
            ...
            setTimeout(() => {
                ...
                // In a real app, this would redirect to the admin dashboard upon successful verification
    ...
    function simulateSuccessfulLogin() {
        ...
        successMessage.innerHTML = '<h2>Login Successful!</h2><p>Redirecting to admin dashboard...</p>';
        ...
        // Redirect after a delay to the admin dashboard
        setTimeout(() => {
